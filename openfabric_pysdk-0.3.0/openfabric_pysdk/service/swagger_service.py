...
from openfabric_pysdk.flask.rest import SwaggerMarshmallowPlugin, WebserverSwaggerSpec
...
class SwaggerService:
    ...
    def install(descriptor: ResourceDescriptor, webserver: Webserver):
        logger.info(f"Openfabric - install Specs REST endpoints on {descriptor.endpoint}")
